    ...
    <div class="mx-auto max-w-7xl sm:px-6 lg:px-8">
        <div class="overflow-hidden bg-white shadow-sm sm:rounded-lg dark:border dark:border-gray-700 dark:bg-gray-800">
            <div class="p-6 text-gray-900 dark:text-gray-100">
                <h1 class="mb-6 text-2xl font-bold text-gray-900 dark:text-gray-100">Modifier le fournisseur</h1>
                ...
                <form action="{{ route('suppliers.update', $supplier) }}" method="POST">
                    ...
                    <div class="mb-4">
                        ...
                        <textarea name="address" id="address" rows="3"
                                  class="w-full rounded border border-gray-300 bg-white px-3 py-2 text-gray-900 dark:border-gray-600 dark:bg-gray-700 dark:text-gray-100">{{ old('address', $supplier->address) }}</textarea>
                    </div>
